...
//Логика такая, что если введена длинная ссылка,которая уже была, в файле уже есть сокращенная,записанная 
//через: длинная ссылка:короткая ссылка//показываем ее
//если ссылка новая, создаем сокращенную новую и записывем в файл
//Не работают
//функции record_shortURL()
//findExistentShortURL()

//Само сокращение ссылки происходит
